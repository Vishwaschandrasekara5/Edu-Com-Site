    ...
    <div className='my-24 md:px-14 px-4 max-w-screen-2xl mx-auto' id="feature">
       <div className='flex flex-col lg:flex-row justify-between items-start gap-10'>
          ...
          className='lg:w-1/4'>
            ...
            <p className='text-base text-tartiary'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto libero eos ut distinctio pariatur aliquid sint, corporis deserunt deleniti! Culpa!</p>
          </motion.div>
          <motion.div
